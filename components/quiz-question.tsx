  ...
  return (
    <div className="flex flex-col items-center px-4 py-8 pt-32">
      <div className="max-w-2xl w-full space-y-8">
        ...
        {/* Card container */}
        <div className={layout === "grid" ? "w-full" : "w-full"}>
          {/* Opcoes */}
            ...
            {options.map((option, index) => (
              <button
                ...
                className={layout === "grid"
                  ...
                  : `w-full bg-white/5 border rounded-xl p-5 transition-all duration-200 flex items-center gap-3 ${selectedOption === option.label
